...
class AddBlocksActivity:MainContract.AddWorkflowView, AppCompatActivity() {

    internal lateinit var presenter: MainContract.AddWorkflowContract
    protected lateinit var newWorkflow:Workflow
...
//segnatura funzione: setOnItemClickListener(AdapterView<?> parent, View view, int position, long id)
    ...
    override fun setPresenter(presenter: MainContract.AddWorkflowContract) {
